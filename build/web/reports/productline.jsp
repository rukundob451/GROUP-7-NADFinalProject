	...
	<main class="content-wrap">
		...
		<%
            ...
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/projectdb", "root","");
                ...
                ResultSet rs5 = st5.executeQuery("SELECT * FROM productline");
%>	<h2>Table of Product Line </h2>
	 <table border="1"class="table table-dark">
            ...
            <%
                ...
                <tr>
                    ...
                    <td><%out.println(rs5.getInt(3));%></td>
                    <td><%out.println(rs5.getInt(4));%></td>
                </tr>
            <%
		...
		<%
                ...
                ResultSet rs7 = st7.executeQuery("SELECT * FROM productcategory");
                %>
                <h2>Table of Product Category </h2>
	 <table border="1"class="table table-dark">
            <tr>
                <th>categoryId</th>
                <th>categoryName</th>
            ...
            <%
                ...
                %>
                <tr>
                    <td><%out.println(rs7.getInt(1));%></td>
                    <td><%out.println(rs7.getString(2));%></td>
                    <td><%out.println(rs7.getInt(3));%></td>
                    <td><%out.println(rs7.getInt(4));%></td>
                </tr>
            <%
